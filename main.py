...
async def predict_match(fixture_id: int):
    ...
    features = np.array([[
        home_stats["gf"], home_stats["ga"], home_stats["cs"],
        home_stats["fw"], home_stats["fd"], home_stats["fl"],
        away_stats["gf"], away_stats["ga"], away_stats["cs"],
        away_stats["fw"], away_stats["fd"], away_stats["fl"],
    ]])
